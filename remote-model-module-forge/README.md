...
# 3. Create and commission brick
# Generate spec:
brick describe "A calculator that adds and subtracts numbers"
...
That's it! The single `brick run` command:
...
5. Halt with a complete report

**Recommended workflow:** Use `brick describe` to generate spec, then review and run with `brick run`.
